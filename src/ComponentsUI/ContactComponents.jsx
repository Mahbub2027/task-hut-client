...
function ContactComponents() {
    return (
        ...
        <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
            <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-center text-pink-600 dark:text-white">Contact Us
            </h2>
            <p className="mb-8 lg:mb-16 font-light text-center
             text-gray-500 dark:text-gray-400 sm:text-xl">Got a technical
            ...
            <form action="#" className="space-y-8">
                <div>
                    ...
                    text-gray-900 dark:text-gray-300">Full
                        Name</label>
                ...
                <div>
                    <label //for="email" 
                    className="block mb-2 text-sm font-medium 
                    text-gray-900 dark:text-gray-300">Your
                        email</label>
                ...
                <button type="submit" //onclick="sendMail()"
                    className="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-pink-600 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-pink-600 dark:focus:ring-primary-800">Send
                    message</button>
            </form>
        </div>
    </section>
