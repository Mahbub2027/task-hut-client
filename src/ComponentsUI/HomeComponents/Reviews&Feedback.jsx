        ...
        <>
            <div className="py-24 sm:py-12">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="mx-auto grid max-w-2xl grid-cols-1 gap-20 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                        ...
                        {posts.map((post) => (
                            <article key={post.id} className="group lg:h-56 flex max-w-xl flex-col items-center shadow shadow-indigo-200 rounded-xl bg-white p-4 hover:bg-indigo-500 relative">
