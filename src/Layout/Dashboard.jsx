...
const Dashboard = () => {
    ...
    return (
        <div className='flex '>
            <div className={collapse ? 'w-16 min-h-screen bg-slate-800 text-white py-2 mx-auto text-center' : 'w-72 min-h-screen bg-slate-800 text-white py-2 pl-4 '}>
                        ...
                        <div className="">
                            ...
                            <div className="space-y-2">
                                ...
                                <NavLink to='/dashboard/companyChat' className={({ isActive }) => isActive ? 'active-link' : 'hover-link'}>
                                    <BsChatTextFill className="w-6 h-6" />
                ...
                <div className="space-y-2">
                    ...
                    <NavLink to='/support' className={({ isActive }) => isActive ? 'active-link' : 'hover-link'}>
                        <FaPersonCircleQuestion className="w-6 h-6" />
