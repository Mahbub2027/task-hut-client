        ...
        <div className='p-8'>
            ...
            <div className='p-8 space-y-6'>
                ...
                <div className='space-y-8'>
                    <p className='flex items-center gap-3'><FaCircleExclamation className='w-6 h-6 text-orange-400' /> Your account does not have two-factor authentication turned on.</p>
            ...
            <div className='p-8 space-y-6'>
                ...
                <div className='p-4 flex items-center justify-between'>
                    ...
                    <button className="flex gap-2 items-center text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 shadow-lg shadow-red-500/50 dark:shadow-lg dark:shadow-red-800/80 font-medium rounded-full text-sm px-4 py-2 text-center"><FaXmark className='w-6 h-6' />Remove Device</button>
                </div>
            </div>
        </div>
    );
