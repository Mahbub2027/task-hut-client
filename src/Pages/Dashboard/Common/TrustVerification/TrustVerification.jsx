...
const TrustVerification = () => {
    ...
    return (
        <div className='p-8'>
            ...
            <div className='p-8 my-5 space-y-6 rounded-2xl bg-gradient-to-br from-cyan-50 via-cyan-100 to-cyan-200'>
                <p className='w-full font-medium text-2xl text-cyan-600 pb-2'>What is a trust score?</p>
                <p className='text-lg text-cyan-700'>The User Trust Score is at the core of how we handle verification and trust. The Trust Score is a value that indicates to what extent we have been able to verify who a user says they are. Employers and Companies who are the safest to work with are those who put in more effort to verify themselves to become highly trusted users.</p>
            </div>
            {
