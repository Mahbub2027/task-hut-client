      ...
      <div className="m-5 collapse collapse-plus bg-base-200">
        ...
        <div className="collapse-content">
          <p>
            ...
            transformative experience. TaskHut empowers developers to take
            control of their careers and offers companies the flexibility to
            scale their teams efficiently.
          </p>
        </div>
      </div>
