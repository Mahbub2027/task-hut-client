        ...
        <div className='bg-indigo-500 space-y-10 lg:space-y-20 py-20'>
            ...
            <div className='mx-auto text-center w-3/4 md:w-2/3'>
                <form className='space-y-8' onSubmit={handleOnSubmit} >
                    <textarea className='text-lg outline-none w-full rounded-2xl focus:shadow-md focus:shadow-indigo-700 p-4 text-slate-700 ' name="review" id="" cols="60" rows="8" placeholder='Your experience/opinions here...' required></textarea>
