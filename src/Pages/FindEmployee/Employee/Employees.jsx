        ...
        <div className='group h-[450px] rounded-3xl'>
            ...
            <div className='h-1/2 rounded-b-3xl border-b group-hover:shadow-xl flex flex-col items-center justify-between p-6 transition-all ease-in-out delay-150 duration-500'>
                <div className='flex flex-col items-center gap-1'>
                    ...
                    <p className='flex items-center gap-1 text-slate-600'>{experience} yrs of experience</p>
                    <p className='flex items-center gap-1 text-slate-600'>{workPreference}</p>
                    <p className='flex items-center gap-1 text-slate-600'>{location}, {city}, {country}</p>
                </div>
